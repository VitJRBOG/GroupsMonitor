...
def new_post(sender, sessions_list, subject_data):
...
def new_topic_message(sender, sessions_list, subject_data):
...
def new_album_photo(sender, sessions_list, subject_data):
