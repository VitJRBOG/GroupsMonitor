function switchWardObservationMode(id) {
    var url = "/wards/" + id + "/toggle"
    var redirectURL = "/"
...
function switchObserverMode(wardID, observerName, newMode) {
    var url = "/observers/" + wardID + "/toggle/" + observerName + "/" + newMode
    var redirectURL = "/observers/" + wardID
...
function openNewOperatorPage() {
    var url = "/settings/operators/new";
    window.location.replace(url);
}
...
function openNewWardPage() {
    var url = "/settings/wards/new";
    window.location.replace(url);
}
